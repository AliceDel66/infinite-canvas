export default {
    meta: {
        title: "Weave",
        browserTitle: "Weave · AI Creative Workspace",
        shortDescription: "AI Creative Workspace",
        description: "An AI visual workspace connecting ideas, generations, and assets",
    },
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", referenceMode: "Generation mode", referenceModes: { text_to_video: "Text to video", image_to_video: "Image to video", image_reference: "Image reference", first_last_frames: "First/last frames", omni_reference: "Omni reference" }, sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    auth: {
        login: "Sign in",
        register: "Register",
        loginTitle: "Sign in to Weave",
        registerTitle: "Create an account",
        loginDescription: "Continue with your canvases, assets, and creation history",
        registerDescription: "Create a Weave account and start saving your work",
        name: "Display name",
        ...
        invalidCredentials: "Incorrect email or password. Sign in with your Weave account.",
        accountExists: "This email is already registered. Sign in instead.",
        logout: "Sign out",
        logoutFailed: "Sign-out failed",
        or: "or",
        sub2api: "Continue with Token Shop",
        sub2apiFailed: "Token Shop authorization failed",
        accountBoundary: "Email sign-in currently accepts Weave accounts only. Token Shop is a separate account system; direct sign-in will be available after its OAuth/OIDC authorization service is enabled.",
        loading: "Checking your session",
        backendUnavailable: "Account service unavailable",
        backendUnavailableDescription: "Confirm that the API service and PostgreSQL are running.",
        retry: "Reconnect",
    },
    dataImport: {
        title: "Sync local data to your account",
        summary: "Found {{records}} local records and {{files}} media files totaling {{size}}.",
        scope: "This imports canvases, My Assets, generation history, and referenced media. API keys, WebDAV/Agent credentials, plugin code, and caches stay local. Local data is not deleted.",
        missingFiles: "{{count}} referenced local media files are missing. Their records will still be saved.",
        confirm: "Start import",
        later: "Later",
        retry: "Retry",
        completed: "Local data is now linked to your account",
        failed: "Import did not finish",
        progress: {
            domains: "Saving data {{current}}/{{total}}",
            files: "Uploading media {{current}}/{{total}}",
    ...
    home: {
        ...
        description: "Weave images, video, text, and prompts into one canvas, turning every generation into the start of the next idea.",
        start: "Start creating",
        openCanvas: "Open canvas",
        showcaseEyebrow: "INSPIRATION ARCHIVE",
        showcaseTitle: "Create from proven results",
    ...
    config: {
        ...
        channelEditor: {
            ...
            capabilityAdapter: "Model capability adapter",
            capabilityAdapterDescription: "Auto uses only capabilities returned by this provider. UniArt enrichment is isolated to UniArt relay providers and does not affect other Sub2API providers.",
            capabilityAdapters: { auto: "Auto-detect (standard Sub2API)", uniart: "UniArt capability enrichment" },
