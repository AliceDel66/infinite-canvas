export default {
    meta: {
        title: "织境",
        browserTitle: "织境 · AI 创作工作台",
        shortDescription: "AI 创作工作台",
        description: "连接灵感、生成与素材的 AI 视觉创作工作台",
    },
    theme: { toggle: "切换主题" },
    common: {
        cancel: "取消",
    ...
    settingsPanels: {
        ...
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", resolution: "分辨率", ratio: "比例", duration: "时长", smart: "智能", output: "输出", generateAudio: "生成声音", watermark: "添加水印", adaptive: "自适应", referenceMode: "生成方式", referenceModes: { text_to_video: "文生视频", image_to_video: "图生视频", image_reference: "图片参考", first_last_frames: "首尾帧", omni_reference: "全能参考" }, sizes: { landscape: "横屏", portrait: "竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", cinematic: "宽银幕", adaptive: "自适应" } },
    ...
    auth: {
        ...
        loginTitle: "登录织境",
        registerTitle: "创建账户",
        loginDescription: "继续你的画布、素材与创作记录",
        registerDescription: "创建织境账户，开始保存创作资产",
        name: "昵称",
        nameRequired: "请输入昵称",
        ...
        loginFailed: "登录失败",
        registerFailed: "注册失败",
        invalidCredentials: "邮箱或密码错误，请使用织境账户登录",
        accountExists: "该邮箱已注册，请直接登录",
        logout: "退出登录",
        logoutFailed: "退出登录失败",
        or: "或",
        sub2api: "使用 Token 小铺账户登录",
        sub2apiFailed: "Token 小铺授权失败",
        accountBoundary: "当前邮箱登录仅适用于织境账户。Token 小铺是独立账户系统，待中转站开放 OAuth/OIDC 授权后即可直接登录。",
        loading: "正在确认登录状态",
        backendUnavailable: "账户服务暂时不可用",
        backendUnavailableDescription: "请确认后端服务和 PostgreSQL 已启动。",
        retry: "重新连接",
    },
    dataImport: {
        title: "同步本机数据到账户",
        summary: "检测到 {{records}} 条本地记录和 {{files}} 个媒体文件，共 {{size}}。",
        scope: "将导入画布、我的资产、生成记录和引用媒体。API Key、WebDAV/Agent 凭据、插件代码与缓存不会上传，本机数据不会删除。",
        missingFiles: "有 {{count}} 个本地媒体引用已缺失，将仅保存对应记录。",
        confirm: "开始导入",
        later: "稍后处理",
        retry: "重试",
        completed: "本机数据已绑定到账户",
        failed: "导入未完成",
        progress: {
            domains: "保存数据 {{current}}/{{total}}",
            files: "上传媒体 {{current}}/{{total}}",
            complete: "完成校验",
        },
    },
    home: {
        ...
        description: "把图片、视频、文字与提示词织进同一张画布，让每一次生成都成为下一步创作的起点。",
        start: "开始创作",
        openCanvas: "打开画布",
        showcaseEyebrow: "灵感档案",
        showcaseTitle: "从好结果继续创作",
    ...
    config: {
        ...
        channelEditor: {
            ...
            protocol: "协议",
            baseUrl: "接口地址",
            capabilityAdapter: "模型能力适配",
            capabilityAdapterDescription: "自动检测只使用该渠道实际返回的能力；UniArt 补全仅用于返回基础 Sub2API 模型列表的 UniArt 中转渠道，不影响其他渠道。",
            capabilityAdapters: { auto: "自动检测（兼容普通 Sub2API）", uniart: "UniArt 能力补全" },
            models: "渠道模型",
