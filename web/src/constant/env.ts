...
export const PLUGIN_REGISTRY_URL = import.meta.env.VITE_PLUGIN_REGISTRY_URL || "https://cdn.jsdelivr.net/gh/AliceDel66/infinite-canvas@plugins-dist/official-plugins.json";
